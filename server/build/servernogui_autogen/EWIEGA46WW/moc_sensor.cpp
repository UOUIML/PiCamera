...
QT_MOC_LITERAL(4, 24, 9), // "writeData"
QT_MOC_LITERAL(5, 34, 8) // "readData"

    },
    "Sensor\0resultReady\0\0str\0writeData\0"
    "readData"
};
...
void Sensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->writeData((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sensor::resultReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Sensor::resultReady(QString _t1)
{
